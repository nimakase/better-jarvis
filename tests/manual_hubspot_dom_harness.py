...
COMPANIES = [
    ("Foxconn Industrial Internet", "Alex Test (alex@example.com)", "fii-foxconn.com"),
    ("Jabil Circuit", "Jamie Sample (jamie@example.com)", "jabil.com"),
    ("Arrow Electronics", "Alex Test (alex@example.com)", "arrow.com"),
]
PAGE2 = [
    ("Flex Ltd", "Alex Test (alex@example.com)", "flex.com"),
    ("Avnet Inc", "Jamie Sample (jamie@example.com)", "avnet.com"),
]
...
check("_extract_owner 剥掉了邮箱后缀", good == "Alex Test", good)
